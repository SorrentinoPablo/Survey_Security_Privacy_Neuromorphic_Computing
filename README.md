...
| 2022 | Memristor-Based Security Primitives Robust to Malicious Attacks for Highly Secure Neuromorphic Systems | Jungyeop Oh et al. | Memristive PUF/TRNG / neuromorphic security | Advanced Intelligent Systems | [Link](https://advanced.onlinelibrary.wiley.com/doi/full/10.1002/aisy.202200177)<br>[Talk]()<br>[Code]() |
| 2022 | In-Memory Unified TRNG and Multi-Bit PUF for Ubiquitous Hardware Security | Sachin Taneja, Viveka Konandur Rajanna, Massimo Alioto | PUF/TRNG / In-memory entropy generation | IEEE Journal of Solid-State Circuits | [Link](https://ieeexplore-ieee-org.proxy-ub.rug.nl/abstract/document/9664399)<br>[Talk]()<br>[Code]() |
