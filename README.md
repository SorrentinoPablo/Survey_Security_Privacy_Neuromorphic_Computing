...
| 2023 | SCANN: Side Channel Analysis of Spiking Neural Networks | Karthikeyan Nagarajan et al. | SCA/FIA | Spike timing and activity / information leakage | IEEE TCAS-I | [Link]()<br>[Talk]()<br>[Code]() |
...
| 2023 | Cybersecurity Regulation of Smart Mobility Hardware Systems: Case Assessment for Spin-Based MTJ Devices | Divyanshu Divyanshu et al. | Inference | System-level regulation and leakage risks | IEEE Design and Test | [Link]()<br>[Talk]()<br>[Code]() |
